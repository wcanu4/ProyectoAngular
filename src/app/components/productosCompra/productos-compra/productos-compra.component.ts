...
import { EditarProductosCompraComponent } from '../../productosCompra/editar-productos-compra/editar-productos-compra.component';
import { CrearProductosCompraComponent } from '../../productosCompra/crear-productos-compra/crear-productos-compra.component';
import { NgbModal } from '@ng-bootstrap/ng-bootstrap';

@Component({
  selector: 'app-productos-compra',
  templateUrl: './productos-compra.component.html',
  styleUrls: ['./productos-compra.component.css']
})
...
ngOnInit(): void {
  ...
  abrirModalNuevoProducto() {
    const modalRef = this.modalService.open(CrearProductosCompraComponent);
  ...
  confirmDelete() {
    this.productoService.delete(this.storeToDelete.id).subscribe(
      () => {
  ...
  editarProveedor(proveedor: any) {
    ...
    const modalRef = this.modalService.open(EditarProductosCompraComponent, {
      size: 'lg',
    });
